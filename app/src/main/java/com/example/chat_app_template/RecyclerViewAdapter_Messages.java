...
public class RecyclerViewAdapter_Messages extends RecyclerView.Adapter<RecyclerViewAdapter_Messages.ViewHolder>
{
    ...
    public RecyclerViewAdapter_Messages(Context context, ArrayList<String> txtUsername, ArrayList<String> txtNotification ,ArrayList<String> uid)
    {
